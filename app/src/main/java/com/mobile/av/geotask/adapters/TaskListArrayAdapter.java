...
public class TaskListArrayAdapter extends ArrayAdapter<Task> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView taskTitle = (TextView) rowView.findViewById(R.id.taskTitle_textView_task_row_list);
        TextView expirationDate = (TextView) rowView.findViewById(R.id.expires_date_textView_task_row_list);
        TextView range = (TextView) rowView.findViewById(R.id.range_textView_task_row_list);
        TextView repeat = (TextView) rowView.findViewById(R.id.repeat_textView_task_row_list);
